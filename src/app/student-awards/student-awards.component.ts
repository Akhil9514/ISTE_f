  ...
  awards = [
    {
      ...
      <a href="downloadables/student-awards/ISTE Kerala Award 16 form.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/Kerala Award Poster 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>`
    },
    {
      ...
      <a href="downloadables/student-awards/NIT, Kozhikode 16 form.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/ISTE NIT poster 15.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
      `
    },
    {
      ...
      <a href="downloadables/student-awards/BBSB 16 Form.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/BBSB POSTER 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
      `
    },

    {
      ...
      <a href="downloadables/student-awards/D Bansal Form.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/Devinder Singh Bansal Memorial Award POSTER 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
      `
    },

    {
      ...
      recommended through Head of the institution and submit ONE COPY to : 
      <br>
      <br>
      <strong>The Vice Chancellor</strong><br>
       Narsee-Monjee Institute of Management & Higher Studies (Deemed University), <br>
      Vile Parle (West), <br>
      Mumbai – 400 056, Maharashtra
      <br>
      <br>

      <a href="downloadables/student-awards/Narsee-Monjee 2016.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/NM POster 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
...

    {
      ...
      <a href="downloadables/student-awards/mah students award 2016 form.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/MAHARASHTRA STATE ENGINEERING DESIGN AWARD poster 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
      `
    },
    {
      ...
      <a href="downloadables/student-awards/PTU 2015.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text download-form" (click)="downloadForm()">DOWNLOAD-FORM</span></strong> </a>
      &nbsp;&nbsp;&nbsp;
      <a href="downloadables/student-awards/PTU Award Poster 16.pdf" target="_blank" style="text-decoration: none;"><strong><span class="linked-text award-details" (click)="viewAwardDetails()">AWARD DETAILS</span></strong></a>
      `
    },
